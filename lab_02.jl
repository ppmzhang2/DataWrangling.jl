...
# ╔═╡ 91d48cab-de3f-4920-a466-254f3e6fa89e
begin
	using DataFrames
	using Random
end

# ╔═╡ ad419a34-ff40-473e-8dfc-f560a4458185
using VegaDatasets # this is the equivalent of library(vegadatasets) in R

# ╔═╡ 2d7bbe05-a96a-4c9f-bd0f-df9b589e7ed0
md"""
# Lab 2. The DataFrame
...
# ╔═╡ b150cb54-ee42-4767-b3ec-a1ff142075a2
# We can use the magick @time to measure it:
@time my_df = DataFrame(A=1:10, # the first
    B=rand(10), # second
    C=randstring.(1:10)) # and third column
...
my_df[!,:A] # this gives me the column "A", ! stands for "all rows"

# ╔═╡ 6389a858-59f6-423d-a9bb-e17e3664fecc
md"""
To get a rapid description of the dataframe we can use `describe()`.
"""

# ╔═╡ 4896c9a5-fd7f-44ca-8d63-bcee177ad3c7
describe(my_df)

# ╔═╡ 72a80a29-170b-43df-a8a4-c10f3a81ec91
md"""
and we can access the values it contains by indexing on rows and columns:
"""

# ╔═╡ 37127926-3202-4b0d-8153-f5815073006b
my_df[1,3]

# ╔═╡ baa3fa07-f4d8-42fb-a5b5-ba1ebe6b379a
md"""
This allows us to change the values of certain entries
"""

# ╔═╡ 257e3dc0-ad95-40d0-806e-4a95974fafda
begin
	my_df[1,3] = "B"
	my_df[5,2] = 110.5634564
	my_df
end

# ╔═╡ 5643c9d6-45af-4ddf-91c8-ef45ddf75045
md"""
By default, dataframes in Julia do NOT allow missing values.
Yet, we can modify this behaviour and let my_df take missing values.
"""

# ╔═╡ 1d97f628-6976-4c64-8ee5-063201659309
begin
	allowmissing!(my_df)
    my_df[5,2] = missing
    my_df[4,1] = missing
...
# ╔═╡ 3053b605-9231-4b0a-b214-ef447a11d986
md"""
## Big Dataset

We'll now load a very big dataset in Julia:
"""

# ╔═╡ 18c94329-0dd1-4474-a0c6-c82a127faf6d
flights = dataset("flights-3m") # dataset() is pretty much what data() is in R
...
@time flights_df = DataFrame(flights)

# ╔═╡ cf47636b-f02b-45c6-9886-580de8116810
md"""
We can obtain a quick description of the dataframe with `describe`.
Notice that we are using a pipe, `|>`, which is similar to the R pipe, `%>%`
"""

# ╔═╡ ae8d7322-71d2-49c5-a656-86573498d48a
@time flights_df |> describe
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "8aba641246090d8565d9cf8c222e4a0241784199"
